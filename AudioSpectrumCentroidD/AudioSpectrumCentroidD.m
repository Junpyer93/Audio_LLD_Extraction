function [AudioSpectrumCentroid, XMLFile] =AudioSpectrumCentroidD(audioFile,hopSize,writeXML,XMLFile)
...
if nargin<2 hopSize= 'PT07N1000F'; end %'PT10N1000F'; okkkk
...
% per prevenire una componente non-zero dc e componenti a vera bassa
% frequenza che hanno un peso sproporzionato. 
